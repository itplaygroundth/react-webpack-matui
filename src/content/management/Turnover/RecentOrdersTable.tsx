...
import { Turnover, MembersStatus } from '@src/models/crypto_order';
  ...
  const handleSelectAllCryptoOrders = (
    ...
    setSelectedCryptoOrders(
      event.target.checked
        ? members.map((members:Turnover) => members.id)
        : []
    );
  };
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Turnover ID</TableCell>
              <TableCell>Turnover affiliate</TableCell>
              <TableCell>Turnover name</TableCell>
