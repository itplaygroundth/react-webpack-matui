...
import { CryptoOrder,Partners } from '@src/models/crypto_order';
...
function RecentOrders() {
  ...
  const cryptoOrders: CryptoOrder[] = [
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        const response = await fetch('https://wallet.tsxbet.net/api/Partners/List');
  ...
  return (
    <Card>
      <RecentOrdersTable partners={data} />
    </Card>
  );
}
